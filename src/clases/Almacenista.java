...
public class Almacenista extends Empleado {
    ...
    public Almacenista(int id, String usuario, String contrasenia, char turno, String nombre, String apePaterno, String apeMaterno, char estatusEmpleado, int tipo) {
